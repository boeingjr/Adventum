...
--[[
nt.Shrine = node("Shrine", nt.KillAllAndSolaniansOtherTwo):complete(37442)
nt.TurninMost = node("TurninMost", nt.Shrine):deliver(8334, 37440, 37443, 37439, 37442):other("Sell")
