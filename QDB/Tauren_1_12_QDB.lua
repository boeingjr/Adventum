...
Adventum_Tauren_1_12_QDB={
  [264]={ q=264, t="Until Death Do Us Part", l=16, r=12, s="Horde", si=5543, st="npc", ei=24776, et="object",},
  [743]={ q=743, t="Dangers of the Windfury", l=8, r=5, s="Horde", si=2985, st="npc", ei=2985, et="npc",},
  [744]={ q=744, t="Preparation for Ceremony", l=11, r=7, s="Horde", si=2987, st="npc", ei=2987, et="npc",},
  ...
  [768]={ q=768, t="Gathering Leather", l=8, r=4, s="Horde", si=3050, st="npc", ei=3050, et="npc",},
  [769]={ q=769, t="Kodo Hide Bag", l=10, r=4, s="Horde", si=3050, st="npc", ei=3050, et="npc",},
  ...
  [886]={ q=886, t="The Barrens Oases", l=10, r=10, s="Horde", si=5769, st="npc", ei=3448, et="npc", p=0, n=870,},
  [1519]={ q=1519, t="Call of Earth", l=4, r=4, s="Horde", st="npc", si=5888, et="npc", ei=5888, p=0, n=1520, class="SHAMAN",}, -- [10]
  [1520]={ q=1520, t="Call of Earth", l=4, r=4, s="Horde", st="npc", si=5888, et="npc", ei=5891, p=1519, n=1521, class="SHAMAN",}, -- [10]
  [1521]={ q=1521, t="Call of Earth", l=4, r=4, s="Horde", st="npc", si=5891, et="npc", ei=5888, p=1520, n=0, class="SHAMAN", }, -- [10]
  ...
  [7820]={ q=7820, t="A Donation of Wool", l=60, r=12, s="Horde", si=14728, st="npc", ei=14728, et="npc", o={7821,},},
  [24857]={ q=24857, t="Attack on Camp Narache", l=4, r=1, s="Horde", si=4851, st="item", ei=2981, et="npc",},
}
